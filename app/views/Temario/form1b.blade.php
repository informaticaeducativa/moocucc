...
<table>
	...
	@endforeach
	<tr>
		<th colspan="2"><center>Mensajes en el inicio</center></th>
	</tr>
...
<br>
<h2>Crear contenido de inicio del curso {{ $curso->nombre }}</h2>

<a href="{{ URL::route('ver-curso-info', $curso->id_curso ) }}" class="btn btn-primary" target="_blank">Ver Inicio del Curso</a>
</br>
</br>
...
{{ Form::model($temario, $form_data, array('role' => 'form')) }}
  ...
  <div class="row">
    <div class="form-group col-md-10">
      ...
      {{ Form::text('titulo', null, array('placeholder' => 'Introduce el titulo del contenido', 'class' => 'form-control')) }}
    </div>
    <div class="form-group col-md-10">

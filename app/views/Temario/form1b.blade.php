...
<br><br>
@if ($action == 'Editar')
<a href="{{ URL::route('ver-curso-info', $curso->id_curso ) }}" class="btn btn-primary" >Regresar</a>
@else
...
<a href="{{ URL::route('ver-curso-info', $curso->id_curso ) }}" class="btn btn-warning" target="_blank">Ver mensajes de inicio del Curso</a>
</br>
</br>

...
{{ Form::model($usuario, $form_data, array('role' => 'form')) }}
  ...
  <div class="row">
    ...
    <div class="form-group col-md-5">
      ...
      {{ Form::select('tipo_inteligencia', array('Visual'=>'Visual', 'Kinestésico'=>'Kinestésico', 'Auditivo'=>'Auditivo'), null, array('placeholder' => 'Introduce la fecha de inicio del usuario', 'class' => 'form-control')) }}
    </div>
    <div class="form-group col-md-5">
      {{ Form::label('titulo', 'Titulo o cargo universitario') }}
      {{ Form::text('titulo', null,  array('placeholder' => 'Introduce el título o cargo universitario usuario', 'class' => 'form-control')) }}        
    </div>
